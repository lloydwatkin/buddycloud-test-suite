...
public final class SmackConfiguration {
    ...
    private static boolean throwErrorStanzaExceptions = true;
                    ...
                    try {
                        ...
                        do {
                            if (eventType == XmlPullParser.START_TAG) {
                                ...
                                else if (parser.getName().equals("throwErrorStanzaExceptions")) {
                                	throwErrorStanzaExceptions = Boolean.parseBoolean(parser.nextText());
                                }
                            }
   ...
   /**
    ...
    /**
     * Sets whether to throw an exceptions when SyncPacketSend receives an 
     * error stanaza response from the XMPP server
     * 
     * @param throwErrorStanzaExceptions whether to throw an exception when error stanza encountered
     */
    public static void setThrowErrorStanzaExceptions(boolean throwErrorStanzaExceptions) {
    	SmackConfiguration.throwErrorStanzaExceptions = throwErrorStanzaExceptions;
    }
    
	public static boolean getThrowErrorStanzaExceptions() {
		return throwErrorStanzaExceptions;
	}
}